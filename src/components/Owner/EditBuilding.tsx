...
import { updateBuilding } from '@/service/owner.api';
...
const EditBuilding: React.FC<RoomModalProps> = ({
  isOpen,
  onClose,
  selectedRoom,
  setSelectedRoom,
  ...
  const UpdateMutation = useMutation({
    mutationFn: ({
      ...
      buildingId: string;
      body: SchemaUpdateBuilding;
    }) => updateBuilding(buildingId, body), // Use the updated function
  });
  ...
  const UpdateBuilding = (data: SchemaUpdateBuilding) => {
    ...
    if (buildingId) {
      UpdateMutation.mutate(
        { buildingId, body }, // Pass an object with roomId and formData
        {
          onSuccess: () => {
