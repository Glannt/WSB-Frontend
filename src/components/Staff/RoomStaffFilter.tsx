...
interface RoomStaffFiltersProps {
  rooms?: Room[];
  filterValue: string;
...
const RoomStaffFilters: React.FC<RoomStaffFiltersProps> = ({
  rooms,
  filterValue,
  statusFilter,
  visibleColumns,
  ...
  return (
    <div className="flex justify-between gap-3 items-end">
      <Input
        ...
        style={{ fontSize: '1.2rem', padding: '0.75rem' }} // Increased size
      />
...
export default RoomStaffFilters;
