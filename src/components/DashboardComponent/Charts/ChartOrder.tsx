...
const options: ApexOptions = {
  ...
  colors: ['#347928', '#FCCD2A', '#3357FF', '#D91656'], // Custom colors for rooms
  labels: ['Đơn đặt', 'Đang chờ xử lý', 'Đã hoàn thành', 'Bị hủy'], // Room types
  legend: {
    show: false,
    position: 'bottom',
  },
...
const ChartOrder: React.FC<ChartBookingProps> = ({ bookingAnalysis }) => {
  ...
  return (
    <div className="sm:px-7.5 col-span-12 rounded-lg shadow-xl shadow-primary-100 bg-default-50 px-5 pb-5 pt-7.5 dark:border-strokedark dark:bg-boxdark xl:col-span-5">
